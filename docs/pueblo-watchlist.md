...
> ⚠️ **Agenda automation was broken from Nov 2025 to Jul 2026.** `scripts/monitor_agendas.py` was scraping `pueblo.us/Archive.aspx?AMID=37`, a **defunct** Archive Center whose newest item is May 2022. The PDFs it collected are from **2012–2013** — `city_council-626.pdf`, logged on 2026-02-18 as "the latest agenda" with "no keyword matches," is the **January 14, 2013** agenda. **That all-clear was void.** Fixed 2026-07-29: Pueblo migrated to **CivicClerk**, now wired into the monitor, which **exits 3 with a banner** on a stale or empty source. **49 genuine 2026 agendas/packets have now been scanned** — see §2. Details in `logs/search_log.md` (2026-07-29) and `scripts/README.md`.
...
| 🔴 **Genetec Cloudrunner ALPRs (newly *discovered*, not necessarily newly deployed)** | **[D] Vendor-sourced:** ~70 cameras, reads queried against **CCIC and federal NCIC**; a **second ALPR vendor running in parallel with Flock**.[^12] ⚠️ **No deployment date exists in any source** — these may predate 2026, which likely explains the absence of Genetec ALPR procurement across 49 scanned 2026 agendas. Do not describe them as just-installed. | **Retention, cost, placement map, and use policy are ALL undisclosed.** → CORA the contract, the placement map, the retention schedule, and the query audit log. **Then ask in writing whether the ICE-populated NCIC "Immigration Violator" hotlist is enabled** — EFF documented (June 2026) that it can be toggled on, generating real-time alerts against ICE administrative warrants issued with no judicial review. **Pueblo has that mechanism on both Cloudrunner and Flock.** Note that disabling a vendor's "national lookup" does **not** close it: ATF searched Loveland's data for ICE, and an SFPD audit found 299 improper federal searches via a fusion center. |
...
1. ⚠️ **The "RTCC study" line — weaker than it first looks.** The packet does say *"The subject matter of research will be a comprehensive study of the Real Time Crime Center,"* but **the sentence directly before it** says the research partner is sought *"to study effects of the CIT program,"* and the whole award is a **Crisis Intervention Team co-responder grant** (Health Solutions MOU, HIPAA, 42 CFR Part 2, detox/crisis coordination). **Most plausibly a copy-paste artifact from another application.** → **Still ask the question on the record** — *"is that sentence accurate, who owns the output, will it be published?"* — because it costs nothing and works either way. **But do not headline it as a city-funded RTCC study.**
...
3. **Grant conditions — standard BJA boilerplate, not Pueblo-specific:** condition **#26 bars spending on unmanned aircraft systems (UAS/drones)** entirely, and condition **#27 permits Facial Recognition Technology only if the grantee already has policies protecting Fourth and First Amendment rights.** ⚠️ **#27 is not evidence Pueblo intends to deploy FRT** — it appears on BJA awards generally. The hook is conditional. → **CORA target: does the City of Pueblo have an FRT policy?** If it does not, it cannot lawfully spend this grant on FRT. If it claims one, that document should be public. This condition stacks on top of **[SB22-113](https://leg.colorado.gov/bills/sb22-113)** (signed 2022, **still in force**), which independently requires a **public notice of intent**, an **accountability report**, meaningful human review, operational testing, and a **warrant for real-time identification** before *any* agency use of facial recognition — and bars reliance on FRS alone for probable cause. **No Pueblo SB22-113 filing has been found, and a notice of intent is a public record — that is the cheapest early-warning tripwire on this entire stack.** (SB25-143 additionally requires local school-board approval for FRT in schools, so D60/D70 board agendas are a free monitor.)
...
[^12]: "Pueblo police add license plate reading cameras," *Southeast Colorado News*, Jul 14 2026. https://seconews.org/article/9277 — ~70 Genetec Cloudrunner ALPR cameras citywide, NCIC-queried; Deputy Chief Martin quoted. Retention and cost undisclosed.

[^13]: EFF, "Are Your Local Police Using Flock Safety ALPRs to Scan for Immigrants?" Jun 25 2026. https://www.eff.org/deeplinks/2026/06/are-your-local-police-using-flock-safety-alprs-scan-immigrants — ICE-populated NCIC "Immigration Violator" hotlist can be enabled inside Flock; includes a records-request template.

[^14]: Colorado DCJ, *Contacts & Use of Force Report, CY2024*. https://cdpsdocs.state.co.us/ors/Docs/Reports/2025_LEI-Rpt-CY2024.pdf — **PCSO reported 0 of 12 months**; PPD reported 10 of 12 (244.2 uses per 10k contacts, 3 deaths); neither reported race data.

[^15]: SoundThinking, "How Pueblo PD Uses ShotSpotter and BRINC Drone Integration." https://www.soundthinking.com/blog/how-pueblo-pd-uses-shotspotter-and-brinc-drone-integration/ — ShotSpotter alert **auto-triggers** drone launch, gated only by an operator feasibility check. 3,383 alerts vs 608 911 calls — **period not stated in the source, and it conflicts with the 7,715-detection 2025 figure elsewhere in this repo. Do not quote a percentage until reconciled.**. Compare against PPD's public UAV page (https://www.pueblo.us/2435/UAV-Unit), which still describes a 2018 three-drone unit.

[^16]: "Cañon City to turn off, remove LPR cameras," *Cañon City Daily Record*, Jun 10 2026. https://www.canoncitydailyrecord.com/2026/06/10/canon-city-to-turn-off-remove-lpr-cameras/ — nearest transferable precedent (40 mi); the police chief himself cited data-security concerns.
