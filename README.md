...
- **City Council, July 27, 2026, item N3** — a **$275,384 Colorado DCJ grant** (project PS2509). The packet states: *"The subject matter of research will be a comprehensive study of the **Real Time Crime Center**,"* assigned to PPD's Crime Analyst and a **Threat Liaison Officer** with CSU-Pueblo. **PPD was also added as one of five new DOJ National Public Safety Partnership sites.** Grant condition **#26 bars drone spending**; **#27 permits facial recognition only if the City already has civil-liberties policies in place**. **Does that policy exist? CORA it.** — and note it stacks on top of **[SB22-113](https://leg.colorado.gov/bills/sb22-113)** (signed 2022, still in force), which independently requires a **public notice of intent, an accountability report, and a warrant for real-time identification** before *any* agency use of facial recognition. **No Pueblo SB22-113 filing has been found. A notice of intent is a public record — that is the cheapest early-warning check available on this whole stack.**
- 🔴 **A SECOND ALPR SYSTEM the repo didn't know about: ~70 Genetec Cloudrunner cameras citywide, queried against federal NCIC.** An order of magnitude beyond the 22 fixed ALPRs previously documented, running in parallel with Flock. **Retention, cost, placement, and use policy all undisclosed.** This is the largest change to Pueblo's surveillance footprint since the RTCC opened.
...
- **ShotSpotter now auto-launches a BRINC drone**, gated only by an operator feasibility check — no warrant. **83% of Pueblo's 3,383 ShotSpotter alerts had no corresponding 911 call.** PPD's public UAV page still describes a 2018 three-drone unit.
- **PCSO reported ZERO of 12 months of state-mandated use-of-force data for CY2024** (PPD reported 10/12; neither reported race data). A documented compliance failure requiring no CORA request — and the sheriff responsible just lost his primary.
